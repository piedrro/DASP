...
from segmentors.cellpose_model import model_wrapper
...
if __name__ == '__main__':
    ...
    model_path = r"/home/turnerp/PycharmProjects/AK-DASP/models/cellpose/DASP-segmentor-cellpose-230607_1533_weights"
    ...
    # model.tune_hyperparamters(num_trials=50, num_images = 1000, num_epochs = 10)
